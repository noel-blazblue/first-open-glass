...
class GlassActivity : android.app.Activity() {
    ...
    private lateinit var hud: GlassHudView
    private lateinit var imu: ImuTracker
    private lateinit var spatial: SpatialHost
    private lateinit var camera: GlassCamera
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val calib = com.glass.dining.glass.spatial.SensorProbe.dump(this, spatial.imu)
        Log.i(
            TAG,
